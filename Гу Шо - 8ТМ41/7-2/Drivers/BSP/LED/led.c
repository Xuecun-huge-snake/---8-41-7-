...
void led_init(void)
{
	...
	gpio_init_struct.Pin = LED4_GPIO_PIN;                   /* LED4引脚 */
    HAL_GPIO_Init(LED4_GPIO_PORT, &gpio_init_struct);       /* 初始化LED4引脚 */
	
	gpio_init_struct.Pin = LED5_GPIO_PIN;                   /* LED5引脚 */
    HAL_GPIO_Init(LED5_GPIO_PORT, &gpio_init_struct);       /* 初始化LED5引脚 */
